...
export class ApiServiceService {
  ...
  getMovieBySearchTerm(query: any) {
    return this.http.get(`http://www.omdbapi.com/?apikey=abaf86c9&t=${query}`);
  }

  getMoviesBySearchTerm(query: any) {
    return this.http.get(`http://www.omdbapi.com/?apikey=abaf86c9&s=${query}`);
  }

  getMovieById(query: any) {
    return this.http.get(`http://www.omdbapi.com/?apikey=abaf86c9&i=${query}`);
  }

  async getMovieByIdAsync(query: any){
    return await fetch(`http://www.omdbapi.com/?apikey=abaf86c9&&i=${query}`);
  }
  ...
  getBookGGBookID(query: any) {
    return this.http.get(`https://www.googleapis.com/books/v1/volumes/${query}?key=AIzaSyCgpHvEOxTlFQNSs78C7CuggQ7rdha72IA`);
  }
  ...
  getBooksGGBookTitleSearch(query: any) {
    return this.http.get(`https://www.googleapis.com/books/v1/volumes?q=+intitle:${query}&key=AIzaSyCgpHvEOxTlFQNSs78C7CuggQ7rdha72IA`);
  }
