...
module.exports = (app) => {
  ...
  router.post("/:uid/:titrelist/movies", allLists.addFilmToAList);
  ...
  router.delete("/:uid/:isbn", allLists.deleteBookFromAllLists);

  router.delete("/:uid/:titrelist/:isbn", allLists.deleteBookFromList);

  router.post("/:uid/:titrelist/books", allLists.addBookToAList);

  router.get("/:uid/:titrelist/:isbn", allLists.findBookFromOneList);
