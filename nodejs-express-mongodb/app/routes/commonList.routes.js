module.exports = (app) => {
    ...
    router.post("/books/:uid/:titrelist", commonList.addBook);
    
    router.get("/:uid/:titrelist/:isbn", commonList.findBook);
    
    router.delete("/:uid/:titrelist/:isbn", commonList.deleteBookFromCommonList);
